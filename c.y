...
struct_declarator_list
	...
	| struct_declarator_list ',' struct_declarator -> new ASTNode('StructDeclaratorList', [$1, $3])
	;
...
type_name
	...
	| specifier_qualifier_list abstract_declarator -> new ASTNode('TypeName', [$1, $3])
	;
...
direct_abstract_declarator
	...
	| direct_abstract_declarator '[' constant_expression ']' -> new ASTNode('DirectAbstractDeclarator', [$1, $3])
	| '(' ')' -> new ASTNode('DirectAbstractDeclarator', [])
	| '(' parameter_type_list ')' -> new ASTNode('DirectAbstractDeclarator', [$2])
	| direct_abstract_declarator '(' ')' -> new ASTNode('DirectAbstractDeclarator', [$1])
	| direct_abstract_declarator '(' parameter_type_list ')' -> new ASTNode('DirectAbstractDeclarator', [$1, $3])
	;
